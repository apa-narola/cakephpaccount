...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">
            <?php echo $group["UserGroup"]["name"]; ?> - Parties
        ...
        <ol class="breadcrumb">
            ...
            <li>
                ...
                <a href="<?php echo $this->webroot; ?>allGroups">Groups</a>
            </li>
            <li class="active">
                <i class="fa fa-users"></i> <?php echo $group["UserGroup"]["name"]; ?> - Parties
            </li>
            <!--<li class="pull-right">
    ...
    <div class="panel-body">
        ...
        <?php echo $this->Form->create('UserGroup', array('action' => 'groupUsers', 'role' => 'form')); ?>
        ...
        <div class="col-lg-1">
            <div class="form-group">
                <?php echo $this->Form->button('Reset', array('type' => 'button', 'class' => "btn btn-default", "onclick" => "window.location='" . $this->webroot . "groupUsers/" . $groupId . "'")); ?>
            </div>
        </div>
...
//							echo "<td>" . h($group['UserGroup']['name']) . "</td>";
                                echo "<td>";
                                ...
                                if ($row['User']['id'] != 1 && $row['User']['username'] != 'Admin') {
                                    echo $this->Form->postLink("&nbsp;<i class='fa fa-trash' title='Delete'></i>", array('action' => 'deletePartyFromGroup', $row['User']['id']), array('escape' => false, 'confirm' => __('Are you sure you want to delete this Partie?')));
                                }
                                echo "</td>";
                                echo "</tr>";
                            }
