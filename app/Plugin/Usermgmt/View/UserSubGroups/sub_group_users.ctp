...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">
            <?php echo $subGroup["UserSubGroup"]["name"]; ?> - Parties
        ...
        <ol class="breadcrumb">
            ...
            <li>
                ...
                <a href="<?php echo $this->webroot; ?>allSubGroups">Sub Groups</a>
            </li>
            <li class="active">
                <i class="fa fa-users"></i> <?php echo $subGroup["UserSubGroup"]["name"]; ?> - Parties
            </li>
            <!--<li class="pull-right">
    ...
    <div class="panel-body">
        ...
        <?php echo $this->Form->create('UserSubGroup', array('action' => 'subGroupUsers', 'role' => 'form')); ?>
        ...
        <div class="col-lg-1">
            <div class="form-group">
                <?php echo $this->Form->button('Reset', array('type' => 'button', 'class' => "btn btn-default", "onclick" => "window.location='" . $this->webroot . "groupUsers/" . $subGroupId . "'")); ?>
            </div>
        </div>
...
//							echo "<td>" . h($subGroup['UserSubGroup']['name']) . "</td>";
                                echo "<td>";
                                ...
                                if ($row['User']['id'] != 1 && $row['User']['username'] != 'Admin') {
                                    echo $this->Form->postLink("&nbsp;<i class='fa fa-trash' title='Delete'></i>", array('action' => 'deletePartyFromSubgroup', $row['User']['id']), array('escape' => false, 'confirm' => __('Are you sure you want to delete this Partie?')));
                                }
                                echo "</td>";
                                echo "</tr>";
                            }
