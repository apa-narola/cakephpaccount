...
<div class="row">
    <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <i class="fa fa-edit fa-fw"></i> <a href="<?php echo $this->webroot ?>allReferences">References</a>
            </li>
            <li class="active">
                <i class="fa fa-user"></i> Add Reference
            </li>
        </ol>
        <?php echo $this->Session->flash(); ?>
        <div class="col-lg-12">
            <?php echo $this->Form->create('User', array('action' => 'addReference', 'role' => 'form')); ?>
